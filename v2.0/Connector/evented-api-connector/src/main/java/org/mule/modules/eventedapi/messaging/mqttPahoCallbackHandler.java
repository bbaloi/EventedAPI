...
public class mqttPahoCallbackHandler implements ICallback, MqttCallback
{

	private static Logger logger = LoggerFactory.getLogger(mqttPahoCallbackHandler.class);
	
	private ISubject _subject;
	
	private EventedApiConnector _connector;
	
	public  mqttPahoCallbackHandler()
	{
		logger.info("Paho MQTT Callback Handler init: !");
	}
	...
	public void messageArrived(String arg0, MqttMessage arg1) throws Exception {
		// TODO Auto-generated method stub
		logger.info("Got Incomming Paho MQTT Message: "+ arg0+ ", message="+arg1);
	...
	public void handleMessage(Object pMessage) throws Exception {
		...
		_newEvent.setTransportType("mqttPaho");
